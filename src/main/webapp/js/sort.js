...
!function (t, e) {
    ...
    var q, V, Z, $, Q, J, tt, et, nt, ot, it, rt, at, lt, st, ct, ut, dt, ht, ft, pt, gt, mt, vt, bt, yt = !1, wt = !1,
        ...
        Mt = w || y ? "cssFloat" : "float", At = xt && !c && !n && "draggable" in document.createElement("div"),
        Nt = function () {
            if (xt) {
                if (y) return !1;
    ...
    Bt.prototype = {
        constructor: Bt, _isOutsideThisEl: function (t) {
            ...
            z("dragStart", this, {evt: t}), Bt.eventCanceled ? this._onDrop() : (z("setupClone", this), Bt.eventCanceled || ((tt = _(q)).draggable = !1, tt.style["will-change"] = "", this._hideClone(), I(tt, this.options.chosenClass, !1), Bt.clone = tt), n.cloneId = Lt(function () {
