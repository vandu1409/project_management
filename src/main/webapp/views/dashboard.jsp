...
<section class="bg-gray-900  h-screen flex text-gray-900 ">
    <!-- Sidebar -->
    <aside class="w-48 p-3 border-r border-dotted border-gray-600">
        ...
        <nav>
            <ul>
                <li class="mb-3 flex justify-between items-center">
                    <span href="#" class="block p-2 font-normal  rounded-lg text-white ">Dự án của bạn</span>
            ...
            <c:forEach var="board" items="${board_list}" varStatus="loop">
                <div class="board-item ms-2 mt-3  p-2 ${loop.first ? "active" : ''} justify-between flex items-center gap-2 rounded" data-board-id="${board.id}">
                ...
                <a data-url="${pageContext.request.contextPath}/dashboard/delete" class="delete-board" data-board-id="${board.id}">
                <svg width="15px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="white" d="M170.5 51.6L151.5 80l145 0-19-28.4c-1.5-2.2-4-3.6-6.7-3.6l-93.7 0c-2.7 0-5.2 1.3-6.7 3.6zm147-26.6L354.2 80 368 80l48 0 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-8 0 0 304c0 44.2-35.8 80-80 80l-224 0c-44.2 0-80-35.8-80-80l0-304-8 0c-13.3 0-24-10.7-24-24S10.7 80 24 80l8 0 48 0 13.8 0 36.7-55.1C140.9 9.4 158.4 0 177.1 0l93.7 0c18.7 0 36.2 9.4 46.6 24.9zM80 128l0 304c0 17.7 14.3 32 32 32l224 0c17.7 0 32-14.3 32-32l0-304L80 128zm80 64l0 208c0 8.8-7.2 16-16 16s-16-7.2-16-16l0-208c0-8.8 7.2-16 16-16s16 7.2 16 16zm80 0l0 208c0 8.8-7.2 16-16 16s-16-7.2-16-16l0-208c0-8.8 7.2-16 16-16s16 7.2 16 16zm80 0l0 208c0 8.8-7.2 16-16 16s-16-7.2-16-16l0-208c0-8.8 7.2-16 16-16s16 7.2 16 16z"/></svg>
    ...
    <!-- Main Content -->
    <main class=" grow flex-col main-section relative ">
        <!-- Header -->
        <header class="px-4 py-3 flex justify-between items-center  bg-gray-700 z-0">

            <h1 class="text-2xl font-semibold text-white board-name">  ${selected_board.title}</h1>

        </header>

        <!-- Kanban Board -->
        <section class="flex p-6 space-x-6 overflow-x-auto ">
            <!-- Danh sách công việc -->
            <div class="w-72 bg-[#000000] rounded-lg shadow-md h-fit">
                <h2 class="font-bold text-sky-300 text-xl p-3">To Do</h2>
                <div class="task-list space-y-4 p-2 " id="todo">
            ...
            <div class="task-list-container"  data-task-url ="${pageContext.request.contextPath}/dashboard/board_id">
            ...
            <!-- Danh sách công việc -->
            <div class="w-72 bg-[#000000] rounded-lg shadow-md h-fit">
                <h2 class="font-bold text-yellow-300 text-xl p-3 ">Inprogres</h2>

                <div class="task-list space-y-4 p-2 " id="inprogress">
                    <div class="task  p-2 rounded-lg bg-[#22272B] border-solid cursor-pointer flex gap-2 border-2 border-transparent hover:border-white"
                         data-bs-target="#exampleModal" data-bs-toggle="modal">
                        <div>
                            <div class="text-white text-sm ">
            ...
            <!-- Danh sách công việc -->
            <div class="w-72 bg-[#000000] rounded-lg shadow-md h-fit">
                <h2 class="font-bold text-green-300 text-xl p-3 ">Done</h2>

                <div class="task-list space-y-4 p-2 " id="done">
                    <div class="task  p-2 rounded-lg bg-[#22272B] border-solid cursor-pointer flex gap-2 border-2 border-transparent hover:border-white"
                         data-bs-target="#exampleModal" data-bs-toggle="modal">
                        <div>
                            <div class="text-white text-sm ">
                ...
                <div class="">
                    <button   data-bs-toggle="collapse" href="#collapseAddTaskList" class="w-[125px] bg-[#000000] text-white p-3 rounded-md font-semibold add-task"
                           >+ Add Task List
                    </button>
                    <div class="collapse !visible w-[125px] max-w-[125px]" id="collapseAddTaskList"
                        >
                        <div  class="form-board card card-body !bg-black p-2">
                        <input required class="border-2 rounded mb-3 px-2 text-dark title-add-list-task" type="text" name="title"
                               placeholder="Task List Name">
                        <button type="submit" class="btn-add-task-list btn btn-primary text-center" data-url="${pageContext.request.contextPath}/dashboard/add_task_list">Tạo</button>
                        </div>
                    </div>
            </div>
