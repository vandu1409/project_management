            ...
            <div class="form-container login-form active">
                ...
                <div class="mx-auto  items-center gap-10 max-w-6xl max-md:max-w-md w-full flex justify-center">
                    ...
                    <form action="${pageContext.request.contextPath}/login"  method="POST"
                        ...
                        <div class="!mt-12">
                            <a >
                                <button  type="submit" class="flex items-center gap-2 justify-center submit-login w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                                    Log in
                                    <span ></span>
                                </button>
                            </a>
            ...
            <div class="form-container register-form">
                ...
                <div class="mx-auto items-center gap-10 max-w-6xl max-md:max-w-md w-full flex justify-center">
                    ...
                    <form action="${pageContext.request.contextPath}/register"  method="POST"
                        ...
                        <div class="!mt-12">
                            <a >
                                <button  type="submit" class="flex items-center gap-2 justify-center w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                                    Register
                                    <span ></span>
                                </button>
                            </a>
